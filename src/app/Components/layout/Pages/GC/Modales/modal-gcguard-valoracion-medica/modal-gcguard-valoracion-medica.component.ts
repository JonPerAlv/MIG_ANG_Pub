...
@Component({
  selector: 'app-modal-gcguard-valoracion-medica',
  templateUrl: './modal-gcguard-valoracion-medica.component.html',
  styleUrls: ['./modal-gcguard-valoracion-medica.component.css'],
  providers: [{ provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }],
  encapsulation: ViewEncapsulation.None,
})


export class ModalGCGuardValoracionMedicaComponent implements OnInit {
  frmValoracion: FormGroup;
  frmListaCheckSintomas: FormGroup;



  tituloAccion: string = 'Registro de Valoración';
  ...
  constructor(
    private modalActual: MatDialogRef<ModalGCGuardValoracionMedicaComponent>,
  ...
  async cargarDatosIniciales() {
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.data.iCveRegistroEvento !== null && this.data.iCveRegistroEvento !== 0) {
        this.tituloAccion = "Editar Valoración Médica";
